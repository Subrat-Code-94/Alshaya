 ...
 */
const getOrderPaymentMethodName = (code, placeholders) => {
  if (!code) {
    return '';
  }

  const methods = [{
    code: 'checkout_com_upapi',
    title: placeholders?.paymentMethodUpapiCard || 'Credit Card/Debit Card',
  }, {
    code: 'checkout_com_upapi_knet',
    title: placeholders?.paymentMethodUpapiKnet || 'KNET',
  }, {
    code: 'checkout_com_upapi_qpay',
    title: placeholders?.paymentMethodUpapiQpay || 'QPAY',
  }, {
    code: 'checkout_com_upapi_vault',
    title: placeholders?.paymentMethodUpapiVault || 'Saved Cards',
  }, {
    code: 'checkout_com_upapi_fawry',
    title: placeholders?.paymentMethodUpapiFawry || 'Fawry Payment',
  }, {
    code: 'banktransfer',
    title: placeholders?.paymentMethodBanktransfer || 'Bank Transfer Payment',
  }, {
    code: 'cashondelivery',
    title: placeholders?.paymentMethodCod || 'Cash On Delivery',
  }, {
    code: 'hps_payment',
    title: placeholders?.paymentMethodHspPayment || 'HPS Gift Card Payment',
  }, {
    code: 'checkout_com_upapi_benefitpay',
    title: placeholders?.paymentMethodUpapiBenefitpay || 'BenefitPay Payment',
  }, {
    code: 'aura_payment',
    title: placeholders?.paymentMethodAuraPayment || 'Aura Payment',
  }, {
    code: 'postpay',
    title: placeholders?.paymentMethodPostpay || 'Postpay',
  }, {
    code: 'checkout_com_upapi_applepay',
    title: placeholders?.paymentMethodUpapiApplepay || 'Apple Pay',
  }, {
    code: 'checkout_com_upapi_googlepay',
    title: placeholders?.paymentMethodUpapiGooglepay || 'Google Pay',
  }, {
    code: 'tabby',
    title: placeholders?.paymentMethodTabby || 'Tabby',
  }];
...
const buildHomeDeliveryDetails = async (order, placeholders) => {
  ...
  const paymentMethod = getOrderPaymentMethodName(order?.payment?.method, placeholders);
...
const renderOrderTotals = async (order, placeholders) => {
  ...
  orderTotal.innerHTML = `
    <div class="col-1">
      ...
      <p class="text-light">(${placeholders?.orderInclusiveOfVat || 'Inclusive of VAT'})</p>
    </div>
    <div class="price">
