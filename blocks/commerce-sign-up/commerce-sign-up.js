...
export default async function decorate(block) {
  ...
  const market = placeholders.market || 'AE';
...
<div class="input-field-wrapper">
  <div class="input-wrapper">
    ...
    <a class="terms-condition-link" href = "/${lang}/website-terms-and-conditions">${placeholders.signupTermsConditionLinkLabel || 'Terms & Conditions.'}</a></span>
  </div>
</div>
