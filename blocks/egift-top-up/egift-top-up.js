import { fetchPlaceholdersForLocale, isLoggedInUser, showToastNotification } from '../../scripts/scripts.js';
import { topUpGiftCardGuest } from '../../scripts/giftcart/api.js';
import { getTopUpAmount, enableTopUpButton, getTopUpOptions } from '../../scripts/giftcart/helper.js';
import {
  resetMessage,
...
`).join('');
  ...
  egiftTopUpButton.addEventListener('click', async (event) => {
    ...
    if (res.response_type === true && !isLoggedInUser()) {
