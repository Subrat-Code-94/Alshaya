...
export default async function decorate(block) {
  ...
  const [titleConentContainer, deliveryMethodsContainer, paymentLogosContainer, , checkoutOrderSummaryContainer, paymentMethods] = block.querySelectorAll('.cart-login > div');
