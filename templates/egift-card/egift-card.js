  ...
  form.innerHTML = `
    <div class="input-field-wrapper">
      <div class="input-wrapper input-field">
        <input type="number" id="egift-number" aria-label="${giftCardNumberPlaceholder}" required inputmode="numeric" pattern="\\d{16}" data-validation-required-message="${invalidNumberError}" />
    ...
    <div class="input-field-wrapper egift-verification-code">
      <div class="input-wrapper input-field">
        <input type="text" id="egift-verification-code" aria-label="${otpPlaceholder}" minlength="6" maxlength="6" data-validation-required-message="${invalidOtpError}" data-validation-too-short-message="${invalidOtpError}" data-validation-too-long-message="${invalidOtpError}" />
